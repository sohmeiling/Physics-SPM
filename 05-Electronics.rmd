...
```{r therm-video, echo=FALSE, fig.cap= "A YouTube video by SPM Malaysia IPTV on thermionic emission", fig.alt = "A video explanation on thermionic emission"}
...
```{r cathode-ray-diff, echo=FALSE, fig.cap="In the first figure, the electrons move from cathode to anode", fig.alt= "Without diffraction, the electrons make the phosphor-coated screen glow directly across the hole in the anode."}
...
<iframe width="1918px" height="967px" frameborder="no" scrolling="no" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" src="https://lab.concord.org/embeddable.html#interactives/interactions/crookesElectrodes.json"></iframe>
