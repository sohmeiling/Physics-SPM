...
```{r cathode-ray-diff, echo=FALSE, fig.cap= "The electrons move from cathode to anode.", fig.alt= "Without diffraction, the electrons make the phosphor-coated screen glow directly across the hole in the anode."}
