...
You can explore how the electron gun is used to emit the electrons

```

```{r add-gun, echo=FALSE, fig.cap="A complicated simulation of electron gun"}

knitr::include_url("https://virtuelle-experimente.de/en/kanone/klassisch/aufbau.php", height = "400px")
